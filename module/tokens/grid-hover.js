...
export class GridHoverHUD extends HLMApplication{
    ...
    initialiseHooks() {
        ...
        Hooks.on("updateActiveEffect",(condition) => refreshGrid(condition.parent));
        Hooks.on("deleteActiveEffect",(condition) => refreshGrid(condition.parent));
        Hooks.on("createActiveEffect",(condition) => refreshGrid(condition.parent));
    }
